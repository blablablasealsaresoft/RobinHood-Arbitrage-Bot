...
// Historical PoolKeys decoded from PoolManager `Initialize` events. Liquidity is
// not assumed to persist: production use must run scanner.js and explicitly
// allowlist only the resulting reviewed watchlist.
export const POOLS = [
  {
    name: 'v4-25pct',
